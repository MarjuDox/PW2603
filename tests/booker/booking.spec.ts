...
// test("Put partial update a booking", async ({request}) => {
//     // get token
//     const authResponse = await request.post('https://restful-booker.herokuapp.com/auth', {
//         data: {
//             username: 'admin',
...
//     // Pick the first booking from the list
...
//     const response = await request.patch(`https://restful-booker.herokuapp.com/booking/${firstBookingId}`, {
//         data: partialUpdatePayload,
//         headers: {'Cookie': `token=${token}`}
//     });

//     expect(response.status()).toBe(200);
//     const partialUpdateResponse = await response.json();
//     console.log(partialUpdateResponse);
    
//     expect(partialUpdateResponse.totalprice).toBe(partialUpdatePayload.totalprice);
//     expect(partialUpdateResponse.additionalneeds).toBe(partialUpdatePayload.additionalneeds);
// });
...
test("PATCH partially update a booking", async ({request}) => {
    ...
    const response = await request.patch(`https://restful-booker.herokuapp.com/booking/${randomBookingId}`, {
        data: partialUpdatePayload,
        headers: {
